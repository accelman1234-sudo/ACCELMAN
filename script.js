...
// ================= FORMULARIO GITHUB (CORREGIDO) =================
// Se asegura que el popup esté oculto al iniciar
document.addEventListener("DOMContentLoaded", () => {
    document.getElementById("formGitHub").style.display = "none";
});

document.getElementById("btnGitHub").addEventListener("click", () => {
    document.getElementById("formGitHub").style.display = "block";
});
