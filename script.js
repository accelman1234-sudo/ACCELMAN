...
btnAgregarURL.addEventListener("click", () => {
    ...
    if(!url.match(/\.(jpeg|jpg|gif|png|webp)$/i)){
        return alert("El link debe ser directo a la imagen (.jpg, .png, .webp, etc.)");
    }
    ...
    if(!modelo || !precio || !categoria) return alert("Completa todos los campos obligatorios");
